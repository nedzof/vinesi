    ...
    <div class="projects-horizontal">
        <div class="container">
            <div class="intro">
                ...
                <form>
                    <div class="form-grou§p"><label class="text-secondary">Unit</label><input class="form-control" type="text" required="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,15}$" inputmode="email"></div>
