                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><a class="action" href="<?php echo url_for('/show.php?id=' . $row['expenseID']); ?>">View</a></td>
...
<div class="col d-flex justify-content-center align-items-center align-content-center align-self-center"
     style="padding: 26px;">
    <button class="btn btn-primary" type="button" style="margin: 0;margin-right: 35px;background-color: #17a2b8;">
